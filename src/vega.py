...
class Vega:
    ...
    def brojanje_logova(self) -> None:
        ...
        print(f"""Ukupno logova: {sum(counts.values())}
Error: {counts["ERROR"]}
...
#tk.Button(root, text="Pisanje ERROR-a u file", command=pisanje_errora, width=30).pack(pady=5)
#tk.Button(root, text="Brojanje logova", command=brojanje_logova, width=30).pack(pady=5)
